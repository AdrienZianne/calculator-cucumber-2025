...
class TestTimes {
	...
	void setUp() {
		  ...
		  try { op = new Operation(params, Operation.Type.TIMES); }
	...
	void testConstructor1() {
		...
		assertThrows(IllegalConstruction.class, () -> op = new Operation(null, Operation.Type.TIMES));
	}
	...
	void testEquals() {
		...
		try {
			Operation e = new Operation(p, Notation.INFIX, Operation.Type.TIMES);
			assertEquals(op, e);
		}
		catch(IllegalConstruction e) { fail(); }
	}
	...
	void testNullParamList() {
		params = null;
		assertThrows(IllegalConstruction.class, () -> op = new Operation(params, Operation.Type.TIMES));
	}
