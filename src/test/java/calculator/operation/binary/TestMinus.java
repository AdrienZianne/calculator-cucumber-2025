...
class TestMinus extends TestBinaryOperation {
	...
	public void TestMyIntegerMyInteger() {
		assertEquals(MyInteger.valueOf(3),
	...
	public void TestMyIntegerMyReal() {
		assertEquals(MyReal.valueOf(4.5),
	...
	public void TestMyIntegerMyComplex() {
		assertEquals(MyComplex.create(5, -10),
	...
	public void TestMyIntegerMyRational() {
		assertEquals(MyRational.create(1, 2),
	...
	public void TestMyRealMyInteger() {
		assertEquals(MyReal.valueOf(3.5),
	...
	public void TestMyRealMyReal() {
		assertEquals(MyReal.valueOf(2-5.5),
	...
	public void TestMyRealMyComplex() {
		assertEquals(MyComplex.create(MyReal.valueOf(5.5), MyReal.valueOf(10)),
	...
	public void TestMyComplexMyInteger() {
		assertEquals(MyComplex.create(1, 2),
	...
	public void TestMyComplexMyReal() {
		assertEquals(MyComplex.create(MyReal.valueOf(0.5), MyInteger.valueOf(2)),
	...
	public void TestMyComplexMyComplex() {
		assertEquals(MyComplex.create(MyReal.valueOf(0), MyReal.valueOf(-1)),
	...
	public void TestMyComplexMyRational() {
		assertEquals(MyComplex.create(MyRational.create(5, 3), MyInteger.valueOf(2)),
				op(MyComplex.create(2, 2), MyRational.create(1, 3)));
	}
	...
	public void TestMyRationalMyReal() {
		assertEquals(MyRational.create(1, 2),
				op(MyRational.create(3, 2), MyReal.valueOf(1)));
	}

	@Test 
    @Override
	public void TestMyRationalMyComplex() {
		assertEquals(MyComplex.create(MyReal.valueOf(-0.5), MyInteger.valueOf(-1)),
	...
	public void TestMyRationalMyRational() {
		assertEquals(MyRational.create(1, 6),
				op(MyRational.create(1, 2), MyRational.create(1, 3)));
	}
	...
	public void TestMyInfinityMyInfinity() {
		assertEquals(new MyInfinity(true),
				op(new MyInfinity(true), new MyInfinity(false)));
		assertEquals(MyUndefinedNumber.class,
				op(new MyInfinity(false), new MyInfinity(false)).getClass());

		assertEquals(new MyInfinity(false),
				op(new MyInfinity(false), new MyInfinity(true)));
	}
	...
	public void TestMyUnknownMyUnknown() {
		assertEquals(ConstantNumber.ZERO,
				op(
						MyUnknown.create(List.of(
										new Pair<>(MyInteger.valueOf(2), MyInteger.valueOf(3)),
										new Pair<>(MyInteger.valueOf(6), MyInteger.valueOf(20))),
	...
	private MyNumber op(MyNumber a, MyNumber b) {
		return BinaryOperation.op(a, b, Minus::new);
	}
}
