...
public class ExpressionParser extends LabeledExprBaseVisitor<Expression> {
     ...
     * @param operation The operation to build and to give the parsed expressions as
     *                  parameters.
     * @return The created operation
     * @param <E> The current parser rule context
     * @param <O> The type of operation to build
     */
    public <E extends ParserRuleContext, O extends Operation> O parseToOperator(E ctx,
