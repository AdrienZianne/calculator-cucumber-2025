...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		SUB=33, ID=34, INT=35, FLOAT=36, NEWLINE=37, WS=38;
	public static final int
	...
	public final SumPostfixContext sumPostfix() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 112742629412L) != 0)) {
					{
					{
					setState(70);
					_errHandler.sync(this);
	...
	public final SumPrefixContext sumPrefix() throws RecognitionException {
		...
		try {
			...
			case ADD:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 120259084256L) != 0)) {
					{
					{
					setState(211);
					_errHandler.sync(this);
		...
		try {
			...
			case T__6:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 112742891396L) != 0) );
				setState(401);
				match(T__2);
				}
				break;
	...
	public final ComplexNumberContext complexNumber() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 112742367232L) != 0)) {
					{
					setState(478);
					number();
					}
