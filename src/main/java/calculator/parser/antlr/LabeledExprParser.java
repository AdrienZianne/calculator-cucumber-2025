...
public class LabeledExprParser extends Parser {
	...
	public static final int
		...
		MUL=39, DIV=40, ADD=41, SUB=42, EXPONENT=43, MOD=44, BOOL=45, ID=46, INT=47, 
		ENOTATION=48, FLOAT=49, NEWLINE=50, WS=51;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"','", "'useDeg'", "'displayReal'", "'root'", "'log'", "'sqrt'", "'abs'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "MUL", "DIV", "ADD", "SUB", "EXPONENT", "MOD", "BOOL", 
			"ID", "INT", "ENOTATION", "FLOAT", "NEWLINE", "WS"
		};
	}
	...
	public final PostfixBinaryArgsContext postfixBinaryArgs() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 710834200248452L) != 0)) {
				{
				{
				setState(191);
				_errHandler.sync(this);
	...
	public final PrefixBinaryArgsContext prefixBinaryArgs() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 738871780310144L) != 0)) {
				{
				{
				setState(271);
				_errHandler.sync(this);
		...
		try {
			...
			case T__9:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 710834267356164L) != 0) );
				setState(295); 
				_errHandler.sync(this);
				_la = _input.LA(1);
				do {
	...
	public final ComplexNumberContext complexNumber() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 710834133139456L) != 0)) {
					{
					setState(466);
					number(0);
					}
